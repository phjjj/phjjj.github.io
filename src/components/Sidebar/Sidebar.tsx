import { SidebarBox, SidebarHeader, SidebarItem, SidebarList } from "./Sidebar.style";
...
const Sidebar = () => {
  ...
  return (
    <SidebarBox>
      ...
      <SidebarList>
        <Link to={"/"}>
          <SidebarItem active={introMatch ? true : false}>
        ...
        <Link to={"/project"}>
          <SidebarItem active={projectMatch ? true : false}>
